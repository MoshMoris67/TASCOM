...
export const Route = createFileRoute("/")({
  loader: async () => ({ upcoming: await fetchUpcomingEvents(5) }),
  component: Home,
});
...
const highlights = [
  {
    ...
    title: "O & A Level Excellence",
    body: "A rigorous curriculum aligned to Uganda's Ministry of Education, delivered by dedicated educators.",
  },
  {
    img: photos.campusAvenue,
    title: "Talent Development",
    body: "Beyond academics — practical skills, arts, sports and enterprise projects that shape whole people.",
  },
  {
    img: photos.campusGate,
    title: "Safe Boarding & Day",
    body: "A secure, well-supervised environment for boarders and day scholars alike.",
  },
  {
    img: photos.assembly,
    title: "Community First",
    body: "Active engagement with parents, alumni and Mukono through galas, sports and service days.",
  },
];
...
const news = [
  {
    tag: "Announcement",
    date: "2026-07-01",
    title: "Term 2 opening date confirmed",
    excerpt:
      "Students should report on Sunday. See the full calendar for boarders and day scholars.",
  },
  {
    tag: "Achievement",
    date: "2026-06-14",
    title: "Science fair: 3 innovations shortlisted",
    excerpt: "Our Senior 5 team's solar water purifier advances to the national finals.",
  },
  {
    tag: "Event",
    date: "2026-06-02",
    title: "Alumni vs Students gala this Saturday",
    excerpt: "Football, netball and athletics — everyone welcome from 9AM at the school field.",
  },
];
...
const testimonials = [
  {
    q: "The teachers genuinely know each student. My daughter's confidence in sciences transformed here.",
    a: "— Sarah N., Parent",
  },
  {
    q: "The boarding house feels like home. I've grown as a leader through the debate club.",
    a: "— Brian K., S.5 Student",
  },
  {
    q: "Talents College Mukono balances discipline with creativity — that combination is rare and it works.",
    a: "— Rev. James M., Alumnus",
  },
];
    ...
    <div>
        ...
        <div className="relative container-page min-h-[92vh] flex items-end pb-16 md:pb-24 pt-24 text-white">
          <div className="max-w-3xl animate-fade-up">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 max-w-xl">
              Talents College Mukono ia a private co-educational day &amp; boarding secondary school offering 'O' and 'A'
      ...
      <section className="container-page py-20 md:py-28 grid gap-12 md:grid-cols-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-4 md:-right-8 bg-flag-black text-white p-5 rounded-2xl max-w-[240px] shadow-elegant flex gap-3 items-start">
              ...
              <p className="text-sm leading-relaxed">
                A school where every learner's gift is discovered — and stretched.
              </p>
            </div>
          </div>
        </Reveal>
        <Reveal variant="right" delay={120} className="md:col-span-7">
          ...
          <h2 className="mt-2 font-display font-black text-3xl md:text-5xl leading-tight">
            A warm welcome to Talents College Mukono.
          </h2>
          <div className="mt-6 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              For over two decades we have balanced strong curriculum performance with active talent
              and practical skill development. Our aim is simple: to help every young person we
              teach discover what they are good at — and then get remarkably better at it.
            </p>
            <p>
              You will find a school that is disciplined, warm, and unafraid to try new things. We
              welcome you to visit, ask questions and, if you are ready, join a community that takes
              learning — and life — seriously.
            </p>
          </div>
          <div className="mt-6 flex items-center gap-4">
            <div className="size-14 rounded-full bg-flag-yellow grid place-items-center font-display font-bold text-flag-black">
              HT
            </div>
            <div>
      ...
      <section className="bg-muted/40 border-y border-border py-20">
        <div className="container-page">
          <Reveal className="max-w-2xl">
            <div className="text-xs uppercase tracking-widest text-flag-red font-semibold">
              Why Talents College Mukono
            </div>
            <h2 className="mt-2 font-display font-black text-3xl md:text-5xl">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {highlights.map((h, i) => (
              <Reveal key={h.title} variant="up" delay={i * 90}>
                <TiltCard max={7}>
                  <div className="group relative rounded-3xl overflow-hidden aspect-[4/5] block">
                    <img
                      src={h.img}
                      alt=""
                      width={1280}
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-flag-black via-flag-black/40 to-transparent" />
                    <div className="absolute inset-0 p-7 flex flex-col justify-end text-white">
                      <h3 className="font-display font-black text-2xl">{h.title}</h3>
                      <p className="mt-2 text-sm text-white/85 line-clamp-3">{h.body}</p>
                    </div>
                  </div>
                </TiltCard>
              </Reveal>
      ...
      <section className="container-page py-16 grid gap-10 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link
              to="/news"
              className="hidden sm:inline-flex items-center gap-1 text-sm font-semibold hover:text-flag-red"
            >
                ...
                <article className="group grid grid-cols-[auto_1fr] gap-5 p-5 rounded-2xl border border-border bg-card hover:border-flag-red transition-colors">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 text-xs">
                      <span className="px-2 py-0.5 rounded-full bg-flag-red/10 text-flag-red font-semibold">
                        {n.tag}
                      </span>
      ...
      <section className="container-page py-20 grid gap-4 md:grid-cols-3">
        {[
          {
            img: photos.examWriting,
            title: "Ordinary Level (O)",
            desc: "Senior 1–4. A broad foundation across sciences, humanities and languages preparing students for UCE.",
            href: "/academics",
          },
          {
            img: photos.labFlaskHold,
            title: "Advanced Level (A)",
            desc: "Senior 5–6. Specialised subject combinations preparing students for university and career pathways.",
            href: "/academics",
          },
          {
            img: photos.culture1,
            title: "Talents Program",
            desc: "Music, dance, drama, sports, ICT and enterprise clubs — every student develops at least one talent.",
            href: "/student-life",
          },
        ].map((c, i) => (
      ...
      <section className="bg-flag-black text-white py-24 relative overflow-hidden">
        ...
        <Reveal variant="up" className="relative container-page text-center max-w-3xl mx-auto">
          ...
          <blockquote
            key={testi}
            className="animate-fade-in mt-6 font-display text-2xl md:text-3xl leading-snug"
          >
        ...
        <div className="relative rounded-3xl overflow-hidden bg-flag-red p-10 md:p-16 text-white">
          ...
          <div className="relative grid md:grid-cols-2 gap-8 items-center">
            <Reveal variant="left">
              ...
              <h2 className="mt-2 font-display font-black text-3xl md:text-5xl">
                Ready to join Talents College Mukono?
              </h2>
              <p className="mt-4 text-white/85 max-w-md">
                Applications for S.1 and S.5 are now open. Reserve a place, book a campus visit or
                speak directly with the head teacher.
              </p>
              <div className="mt-6 flex flex-wrap gap-3">
                <Magnetic>
                  <Link
                    to="/admissions"
                    className="inline-flex items-center gap-2 h-12 px-6 rounded-full bg-flag-black text-flag-yellow font-semibold hover:bg-flag-black/80"
                  >
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 h-12 px-6 rounded-full bg-white/10 border border-white/30 font-semibold hover:bg-white/20"
                >
                  Book a visit
                </Link>
              </div>
            ...
            <Reveal variant="right" delay={120} className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/10 rounded-2xl p-5 backdrop-blur">
                ...
                <div className="font-semibold text-sm mt-1">
                  Ministry of Education — {school.registration}
                </div>
              </div>
              <div className="bg-white/10 rounded-2xl p-5 backdrop-blur">
